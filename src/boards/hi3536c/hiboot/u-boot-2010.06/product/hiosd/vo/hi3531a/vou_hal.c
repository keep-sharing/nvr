...
{	
    ...
    switch(enLayer)
    {
        ...
        {
            RegAbsAddr = (pReg) + 0 * VHD_REG_LEN;//´ÓVHD0¿ªÊ¼Ó³Éä  V0     
            break;
        }
        case HAL_DISP_LAYER_VHD1:
        {
            RegAbsAddr = (pReg) + 3 * VHD_REG_LEN;//´ÓVHD0¿ªÊ¼Ó³Éä  V3
            break;
        }
        case HAL_DISP_LAYER_VP:
        {
            RegAbsAddr = (pReg) + 1 * VHD_REG_LEN;//´ÓVHD0¿ªÊ¼Ó³Éä  v1
            break;
        }        
        case HAL_DISP_LAYER_VSD0:
        {
            RegAbsAddr = (pReg) + 4 * VHD_REG_LEN;//´ÓVHD0¿ªÊ¼Ó³Éä  v4
            break;
        }
