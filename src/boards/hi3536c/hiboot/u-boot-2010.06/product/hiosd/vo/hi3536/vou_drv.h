...
#define VOU_WBC2_FINISHED_INT    0          /* ÊÇ·ñÊ¹ÓÃWBCÍê³ÉÖÐ¶Ï¿ØÖÆºê */
...
/* Èç¹ûºóÆÚ¿ª·ÅACM²ÎÊýÅäÖÃ£¬ÔòÒÆµ½hi_comm_vo.hÖÐ */
...
{
    VOU_ACM_BLKINFO_S stAcmBlk[4];  // 4Õâ¸öÖµµÄºêÔÝÊ±±»¶¨ÒåÔÚvou_chn.cÖÐ
} VOU_ACM_S;
...
{
    VOU_DEV_TYPE_E  enVoDevType;             /* VOÉè±¸ÀàÐÍ */
    HI_BOOL         bHdVpssRciv;             /* ½ÓÊÕÍ¼Ïñ²ßÂÔÊÇ·ñÐèÒªÍ¨¹ýVPSS½ÓÊÕ */
    HI_BOOL         bSdTdeDisp;              /* ÏÔÊ¾Í¼Ïñ²ßÂÔÊÇ·ñÐèÒªÍ¨¹ýTDEÆ´½Ó */
    HI_BOOL         bSupportWbc;             /* ÉèÖÃÖ§³Öwbc¹¦ÄÜ */
    HI_BOOL         bSptGetScreenFrm;        /* ÊÇ·ñÖ§³Ö»ñÈ¡ÆÁÄ»½Ó¿Ú */
} VOU_DEV_CAPABILITY_S;

/* ½«Dev¡¢LAYERµÄÃ¶¾Ù·ÅÔÚ´Ë´¦ÊÇÎªÁË²»ÈÃmkp²ãµÄ´úÂëÖ±½ÓÊ¹ÓÃÃ¶¾Ù±äÁ¿£¬¶ø±ØÐëÍ¨¹ýµ÷ÓÃÏàÓ¦µÄÄÜÁ¦¼¯½Ó¿ÚÀ´ÊµÏÖ */
/* vou device enumeration */
/* ÎïÀíÏÔÊ¾Í¨Â·Ã¶¾Ù£¬ÐèÒªÓëHAL²ãµÄÏÔÊ¾Í¨Â·Ã¶¾ÙÒ»Ò»¶ÔÓ¦ */
...
typedef enum
{
    ...
    VOU_SW_LAYER_VHD1  = 1,    
    VOU_SW_LAYER_VP    = 2,
    //VOU_SW_LAYER_VHD2  = 2,     /* ÔÝÊ±Èí¼þ²ãÃæÉÏ£¬HD2ºÍSD5Ò»ÖÂ£¬ºÍÓ²¼þÌØÐÔ±£³ÖÒ»ÖÂ£¬ÒÔºóÔÙ¸Ä */
    VOU_SW_LAYER_VSD0  = 3,
    //VOU_SW_LAYER_VSD1  = 2,
    //VOU_SW_LAYER_VSD2  = 5,
    //VOU_SW_LAYER_VSD3  = 6,
