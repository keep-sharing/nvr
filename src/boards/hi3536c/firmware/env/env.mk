...
UBOOT_VER_FILE	:= $(UBOOT_DIR)/include/configs/hi3536c.h
...
UBOOT_CMDLINE	= mem=$(ARM_DDR_SIZE) console=ttyAMA0,115200 ubi.mtd=fs1 root=ubi0:rootfs rw rootfstype=ubifs
