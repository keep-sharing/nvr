...
#elif defined CONFIG_TARGET_NA51102_A64
#define CONFIG_PWM_BASE      0x2F0210000
#define CONFIG_TOP_BASE      0x2F0010000
#define CONIFG_CG_BASE       0x2F0020000

#elif defined CONFIG_TARGET_NA51103
#define CONFIG_PWM_BASE      0xF0120000
...
#elif defined CONFIG_TARGET_NA51102_A64
	if (pwm_id < 4) {
		*(u32 *)(CONIFG_CG_BASE + 0x30) &= ~(0x3FFF);
		*(u32 *)(CONIFG_CG_BASE + 0x30) |= (div & 0x3FFF);
	} else if (pwm_id < 8) {
		*(u32 *)(CONIFG_CG_BASE + 0x30) &= ~(0x3FFF << 16);
		*(u32 *)(CONIFG_CG_BASE + 0x30) |= ((div << 16) & (0x3FFF << 16));
	} else if (pwm_id == 8) {
		*(u32 *)(CONIFG_CG_BASE + 0x34) &= ~(0x3FFF);
		*(u32 *)(CONIFG_CG_BASE + 0x34) |= (div & 0x3FFF);
	} else if (pwm_id == 9) {
		*(u32 *)(CONIFG_CG_BASE + 0x34) &= ~(0x3FFF << 16);
		*(u32 *)(CONIFG_CG_BASE + 0x34) |= ((div << 16) & (0x3FFF << 16));
	} else if (pwm_id == 10) {
		*(u32 *)(CONIFG_CG_BASE + 0x38) &= ~(0x3FFF);
		*(u32 *)(CONIFG_CG_BASE + 0x38) |= (div & 0x3FFF);
	} else if (pwm_id == 11) {
		*(u32 *)(CONIFG_CG_BASE + 0x38) &= ~(0x3FFF << 16);
		*(u32 *)(CONIFG_CG_BASE + 0x38) |= ((div << 16) & (0x3FFF << 16));
	}
#elif defined CONFIG_TARGET_NA51103
	if (pwm_id == 0) {
		*(u32 *)(CONIFG_CG_BASE + 0x34) &= ~(0x3FFF);
...
void nvt_pwm_set_pinmux(int pwm_id, u32 pwm_pinmux)
{
	...
	if (pwm_id == 0) {
		if (pwm_pinmux & PIN_PWM_CFG_PWM0_1) {
			*(u32 *)(CONFIG_TOP_BASE + 0x18) &= ~(0x7 << (pwm_id * 4));
			*(u32 *)(CONFIG_TOP_BASE + 0x18) |= (0x1 << (pwm_id * 4));
			*(u32 *)(CONFIG_TOP_BASE + 0xA8) &= ~(0x1 << pwm_id);
		} else if (pwm_pinmux & PIN_PWM_CFG_PWM0_2) {
			*(u32 *)(CONFIG_TOP_BASE + 0x18) &= ~(0x7 << (pwm_id * 4));
			*(u32 *)(CONFIG_TOP_BASE + 0x18) |= (0x2 << (pwm_id * 4));
		...
		if (pwm_pinmux & PIN_PWM_CFG_PWM4_1) {
			...
			*(u32 *)(CONFIG_TOP_BASE + 0x18) &= ~(0x7 << (pwm_id * 4));
			*(u32 *)(CONFIG_TOP_BASE + 0x18) |= (0x2 << (pwm_id * 4));
			*(u32 *)(CONFIG_TOP_BASE + 0xB4) &= ~(0x1 << 2);
		} else {
			*(u32 *)(CONFIG_TOP_BASE + 0x18) &= ~(0x7 << (pwm_id * 4));
		}
	} else if (pwm_id == 5) {
		if (pwm_pinmux & PIN_PWM_CFG_PWM5_1) {
			...
			*(u32 *)(CONFIG_TOP_BASE + 0x18) &= ~(0x7 << (pwm_id * 4));
			*(u32 *)(CONFIG_TOP_BASE + 0x18) |= (0x2 << (pwm_id * 4));
			*(u32 *)(CONFIG_TOP_BASE + 0xB4) &= ~(0x1 << 3);
		} else {
			*(u32 *)(CONFIG_TOP_BASE + 0x18) &= ~(0x7 << (pwm_id * 4));
		}
	} else if (pwm_id == 6) {
		if (pwm_pinmux & PIN_PWMII_CFG_PWM6_1) {
			...
			*(u32 *)(CONFIG_TOP_BASE + 0x18) &= ~(0x7 << (pwm_id * 4));
			*(u32 *)(CONFIG_TOP_BASE + 0x18) |= (0x2 << (pwm_id * 4));
			*(u32 *)(CONFIG_TOP_BASE + 0xB4) &= ~(0x1 << 4);
		} else {
			*(u32 *)(CONFIG_TOP_BASE + 0x18) &= ~(0x7 << (pwm_id * 4));
		}
	} else if (pwm_id == 7) {
		if (pwm_pinmux & PIN_PWMII_CFG_PWM7_1) {
			...
			*(u32 *)(CONFIG_TOP_BASE + 0x18) &= ~(0x7 << (pwm_id * 4));
			*(u32 *)(CONFIG_TOP_BASE + 0x18) |= (0x2 << (pwm_id * 4));
			*(u32 *)(CONFIG_TOP_BASE + 0xB4) &= ~(0x1 << 5);
		} else {
			*(u32 *)(CONFIG_TOP_BASE + 0x18) &= ~(0x7 << (pwm_id * 4));
		}
	} else if (pwm_id == 8) {
		if (pwm_pinmux & PIN_PWMII_CFG_PWM8_1) {
			*(u32 *)(CONFIG_TOP_BASE + 0x1C) &= ~(0x7 << ((pwm_id - 8) * 4));
			*(u32 *)(CONFIG_TOP_BASE + 0x1C) |= (0x1 << ((pwm_id - 8) * 4));
			*(u32 *)(CONFIG_TOP_BASE + 0xA8) &= ~(0x1 << pwm_id);
		} else if (pwm_pinmux & PIN_PWMII_CFG_PWM8_2) {
			*(u32 *)(CONFIG_TOP_BASE + 0x1C) &= ~(0x7 << ((pwm_id - 8) * 4));
			*(u32 *)(CONFIG_TOP_BASE + 0x1C) |= (0x2 << ((pwm_id - 8) * 4));
			*(u32 *)(CONFIG_TOP_BASE + 0xA0) &= ~(0x1 << 4);
		} else {
			*(u32 *)(CONFIG_TOP_BASE + 0x18) &= ~(0x7 << ((pwm_id - 8) * 4));
		}
	} else if (pwm_id == 9) {
	...
	if (pwm_id == 0) {
		if (pwm_pinmux & PIN_PWM_CFG_PWM0) {
			*(u32 *)(CONFIG_TOP_BASE + 0x18) &= ~(0x1 << (pwm_id * 2));
			*(u32 *)(CONFIG_TOP_BASE + 0x18) |= (0x1 << (pwm_id * 2));
			*(u32 *)(CONFIG_TOP_BASE + 0xA8) &= ~(0x1 << 24);
		} else {			
		...
		if (pwm_pinmux & PIN_PWM_CFG_PWM1) {
			*(u32 *)(CONFIG_TOP_BASE + 0x18) &= ~(0x1 << (pwm_id * 2));
			*(u32 *)(CONFIG_TOP_BASE + 0x18) |= (0x1 << (pwm_id * 2));
			*(u32 *)(CONFIG_TOP_BASE + 0xA8) &= ~(0x1 << 25);
		} else {
			DBG_ERR("!!Caution!!>>using pwm_id(%d) but pwm_pinmux(0x%x) not configured(check nvt-top.dtsi)\n", pwm_id, pwm_pinmux);
		}
	} else if (pwm_id == 2) {
		if (pwm_pinmux & PIN_PWM_CFG_PWM2) {
			*(u32 *)(CONFIG_TOP_BASE + 0x18) &= ~(0x1 << (pwm_id * 2));
			*(u32 *)(CONFIG_TOP_BASE + 0x18) |= (0x1 << (pwm_id * 2));
			*(u32 *)(CONFIG_TOP_BASE + 0xA8) &= ~(0x1 << 19);
		} else {
			DBG_ERR("!!Caution!!>>using pwm_id(%d) but pwm_pinmux(0x%x) not configured(check nvt-top.dtsi)\n", pwm_id, pwm_pinmux);
		}
	}
...
#ifdef CONFIG_TARGET_NA51090_A64
	sprintf(path, "/top@%lx/%s", CONFIG_TOP_BASE & 0xFFFFFFFF, pwm);
#else
	sprintf(path, "/top@%x/%s", CONFIG_TOP_BASE, pwm);
#endif
...
#elif defined CONFIG_TARGET_NA51102_A64
	/* Enable clk */
	*(u32 *)(CONIFG_CG_BASE + 0x84) |= (0x1 << pwm_id);
	*(u32 *)(CONIFG_CG_BASE + 0xa4) |= (0x1 << 0);
#elif defined CONFIG_TARGET_NA51103
	/* Enable clk */
	*(u32 *)(CONIFG_CG_BASE + 0x7C) |= (0x1 << pwm_id);
	*(u32 *)(CONIFG_CG_BASE + 0x9C) |= (0x1 << 9);
...
#if defined(CONFIG_TARGET_NA51090_A64) || defined(CONFIG_TARGET_NA51102_A64) || defined(CONFIG_TARGET_NA51103)
...
static int get_pwr_id()
{
	...
	cell = (u32*)fdt_getprop((const void*)fdt_addr, nodeoffset, "pwm_id", NULL);
