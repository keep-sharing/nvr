...
{
	if ((pin < C_GPIO(0)) || (pin > C_GPIO(23) && pin < L_GPIO(0)) || \
	(pin > L_GPIO(30) && pin < P_GPIO(0)) || \
	(pin > P_GPIO(37) && pin < HSI_GPIO(0)) || \
	(pin > HSI_GPIO(23) && pin < D_GPIO(0)) || \
	(pin > D_GPIO(13) && pin < S_GPIO(0)) || \
	(pin > S_GPIO(26) && pin < DSI_GPIO(0)) || \
	(pin > DSI_GPIO(10) && pin < A_GPIO(0)) || (pin > A_GPIO(3))) {
