 ...
 */
#include "novatek/na51103_ca53.h"
...
#define CONFIG_BOOTARGS_COMMON				"earlyprintk console=ttyS0,115200 rootwait nprofile_irq_duration=on debug_boot_weak_hash "
...
/* NVT boot related setting */
	...
	#define CONFIG_NVT_BIN_CHKSUM_SUPPORT					/* This option will check rootfs/uboot checksum info. during update image flow */
		...
		#elif defined(_EMBMEM_SPI_NOR_NAND_)

			#define CONFIG_NVT_LINUX_SPINORNAND_BOOT
			/* For flash */
		...
		#if defined(_EMBMEM_SPI_NOR_NAND_)
			#define CONFIG_NVT_LINUX_SPINORNAND_BOOT
		#else
			#define CONFIG_NVT_LINUX_SPINAND_BOOT
		#endif
		...
		#define CONFIG_NVT_SQUASH_SUPPORT
			...
			/* For spi nand device */
			#define CONFIG_NVT_LINUX_SPINAND_BOOT
			#define CONFIG_BOOTARGS		CONFIG_BOOTARGS_COMMON "root=/dev/romblock6 rootfstype=squashfs ro init=/linuxrc "
			#define CONFIG_NVT_SQUASH_SUPPORT
		#elif defined(_EMBMEM_SPI_NOR_NAND_)
			/* For spi nor + nand device */
			#define CONFIG_NVT_LINUX_SPINORNAND_BOOT
			#define CONFIG_BOOTARGS         CONFIG_BOOTARGS_COMMON "root=/dev/romblock6 rootfstype=squashfs ro init=/linuxrc "
			#define CONFIG_NVT_SQUASH_SUPPORT
		#endif
