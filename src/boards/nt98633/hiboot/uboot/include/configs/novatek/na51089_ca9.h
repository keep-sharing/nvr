 ...
 * user can add NVT_CFG_UBOOT_UIMAGE_SIZE and NVT_CFG_UBOOT_ALL_IN_ONE_IMG_SIZE
 * on nvt-info.dtsi to change them.
 */
#if (!defined(CONFIG_NVT_UIMAGE_SIZE) && !defined(CONFIG_NVT_UIMAGE_SIZE))
...
#endif
#endif /* (!defined(CONFIG_NVT_UIMAGE_SIZE) && !defined(CONFIG_NVT_UIMAGE_SIZE)) */
