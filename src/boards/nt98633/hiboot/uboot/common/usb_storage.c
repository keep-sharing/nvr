...
#if defined(CONFIG_USB_EHCI_HCD) || defined(CONFIG_USB_XHCI_NVTIVOT)
/*
...
#define USB_MAX_XFER_BLK	200	//2000 --->500 or 200 //copy deal with "EHCI timed out on TD" by ceg
#else
				      ...
				      struct us_data *us)
{
	 ...
	 */
	blk = USB_MAX_XFER_BLK;//USHRT_MAX; some device cannot support over 0x8000
#else
	blk = 20;
#endif
#else
