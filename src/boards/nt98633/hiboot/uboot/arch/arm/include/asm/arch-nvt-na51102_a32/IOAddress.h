...
#define IOADDR_SYSCNT_CTRL_BASE     (IOADDR_GLOBAL_BASE+0x0FE60000)
...
#define IOADDR_STBC_CG_REG_BASE     (IOADDR_GLOBAL_BASE+0x00580000)
...
// USB
#define IOADDR_USB_REG_BASE         (IOADDR_GLOBAL_BASE+0x005A0000)

// USB3
#define IOADDR_USB3_REG_BASE        (IOADDR_GLOBAL_BASE+0x005B0000)
...
// USB3-CTRL
#define IOADDR_USB3CTL_REG_BASE     (IOADDR_GLOBAL_BASE+0x005F0000)
