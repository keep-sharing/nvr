...
{
#if (!(CONFIG_UART2_PINMUX_NONE && CONFIG_UART3_PINMUX_NONE && CONFIG_UART4_PINMUX_NONE))
	u32 value;
#endif
		...
		value = readl(IOADDR_TOP_REG_BASE + 0xA8);
		writel(value & ~0xC000, IOADDR_TOP_REG_BASE + 0xA8);
		...
		writel(value & ~0x3, IOADDR_TOP_REG_BASE + 0xB4);

		value = readl(IOADDR_TOP_REG_BASE + 0x1C);
		value &= ~0x30;
		writel(value | 0x30, IOADDR_TOP_REG_BASE + 0x1C);
		...
		value = readl(IOADDR_TOP_REG_BASE + 0xA8);
		writel(value & ~0xC0, IOADDR_TOP_REG_BASE + 0xA8);
		...
		value = readl(IOADDR_TOP_REG_BASE + 0xB4);
		writel(value & ~0xC, IOADDR_TOP_REG_BASE + 0xB4);

		value = readl(IOADDR_TOP_REG_BASE + 0x1C);
		value &= ~0x7000;
		writel(value | 0x2000, IOADDR_TOP_REG_BASE + 0x1C);

		value = readl(IOADDR_CG_REG_BASE + 0x74);
		writel(value | 0x800000, IOADDR_CG_REG_BASE + 0x74);
	#elif defined(CONFIG_UART4_PINMUX_CHANNEL_6)
		value = readl(IOADDR_TOP_REG_BASE + 0xB4);
		writel(value & ~0x180, IOADDR_TOP_REG_BASE + 0xA8);

		value = readl(IOADDR_TOP_REG_BASE + 0x1C);
		value &= ~0x7000;
		writel(value | 0x6000, IOADDR_TOP_REG_BASE + 0x1C);
