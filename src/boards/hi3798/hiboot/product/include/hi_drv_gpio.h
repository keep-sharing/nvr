...
#define OUTPUT            (0)
#define INPUT             (1)
#define BUZZ_CTL        MS_GPIO(8,0)
#define RESET_KEY       MS_GPIO(8,4)
#define POWEROFF_CTL	MS_GPIO(7,6)
#define FAN_CTL         MS_GPIO(3,0)
#define SATA_RESET      MS_GPIO(8,5)
#define STATE_LED       MS_GPIO(5,0)
#define VGA_RESET       MS_GPIO(7,1)
