...
#ifndef INPUT_KER2_IMG
#define INPUT_KER2_IMG
#endif /* INPUT_KER2_IMG */
...
#define INPUT_KER2_VER	VER_KER_NUM
...
#define OUTPUT_UPFW_ONLINE_NAME	xstr(OUTPUT_UPFW_ONLINE_IMG) //used for download
...
#define ANALYSIS_KER2_NAME	"/dev/shm/ker2.bin"
