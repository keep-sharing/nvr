...
/* DCC RDET training */
int ddrtrn_dcc_dataeye_read(void)
{
	int result;
...
unsigned int ddrtrn_dcc_get_win(struct ddrtrn_dcc_data *dcc_data, int ck_index, int val_index)
{
	unsigned int win;
...
int ddrtrn_dcc_get_min_win(struct ddrtrn_dcc_data *dcc_data, int ck_index)
{
	int i;
...
unsigned int ddrtrn_dcc_get_ck0_win(struct ddrtrn_dcc_data *dcc_data, unsigned int ck0_win_min)
{
...
unsigned int ddrtrn_dcc_get_ck1_win(struct ddrtrn_dcc_data *dcc_data, unsigned int ck1_win_min)
{
...
void ddrtrn_dcc_data_init(struct ddrtrn_dcc_data *dcc_data)
{
...
int ddrtrn_dcc_get_win_by_rank(struct ddrtrn_dcc_data *dcc_data)
{
	unsigned int i;
	int result = 0;
	int result_rank;
	...
	for (i = 0; i < rank_num; i++) {
		...
		ddrtrn_hal_dcc_restore_two_rank_bdl(&dcc_data->rank[ddrtrn_hal_get_rank_id()]);
...
void ddrtrn_dcc_get_duty(struct ddrtrn_dcc_data *dcc_data, int ck_num, unsigned int cur_duty)
{
	int ck_idx;
...
void ddrtrn_dcc_get_ctrl(struct ddrtrn_dcc_data *dcc_data, int ck_num, unsigned int cur_ctl)
{
	int ck_idx;
...
/* Duty Correction */
unsigned int ddrtrn_dcc_correct_duty(unsigned int cur_duty, unsigned int duty_def)
{
	unsigned int ioctl21;

	if (PHY_DRAMCFG_TYPE_LPDDR4 == ddrtrn_hal_get_cur_phy_dram_type()) {
...
int ddrtrn_dcc_process(struct ddrtrn_dcc_data *dcc_data, int ck_num, unsigned int ioctl21_def)
{
...
int ddrtrn_dcc_get_best_duty(struct ddrtrn_dmc_cfg_sref *cfg_sref, struct ddrtrn_dcc_data *dcc_data)
{
	int ck_num;
...
void ddrtrn_sref_cfg_restore(struct ddrtrn_dmc_cfg_sref *cfg_sref)
{
	unsigned int i;
...
int ddrtrn_dcc_training(void)
{
	...
	for (i = 0; i < rank_num; i++) {
		ddrtrn_hal_set_rank_id(i);
		ddrtrn_hal_dcc_save_two_rank_bdl(&dcc_data->rank[ddrtrn_hal_get_rank_id()]);
	}
