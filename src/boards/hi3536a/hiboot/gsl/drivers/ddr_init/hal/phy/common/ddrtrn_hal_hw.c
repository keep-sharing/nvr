...
void ddrtrn_hal_set_phy_dxnrdqsdly(unsigned int index, unsigned int value)
{
	ddrtrn_reg_write(value,
			ddrtrn_hal_get_cur_phy() + ddrtrn_hal_phy_dxnrdqsdly(index));
}
unsigned int ddrtrn_hal_get_phy_dxnrdqsdly(unsigned int index)
{
	return ddrtrn_reg_read(ddrtrn_hal_get_cur_phy() + ddrtrn_hal_phy_dxnrdqsdly(index));
}

void ddrtrn_hal_set_phy_rain_ctrl(unsigned int value)
{
	ddrtrn_reg_write(value, ddrtrn_hal_get_cur_phy() + DDR_PHY_TRAINCTRL12);
}

unsigned int ddrtrn_hal_get_phy_rain_ctrl(void)
{
