...
int ddrtrn_hal_vref_phy_dram_set(unsigned int base_phy, unsigned int val, unsigned int byte_index)
{
	unsigned int count;
...
#if defined DDR_PHY_S14_CONFIG
void ddrtrn_hal_vref_phy_host_set(unsigned int base_phy,
