...
extern void uart_early_putc(const char chr);
#else
#undef DDR_PUTS
#undef DDR_PUT_HEX
#undef DDR_PUTC
...
#define ddrt_reg_read(addr) ddrtrn_hal_ddrt_read(addr)
#define ddrt_reg_write(val, addr) ddrtrn_hal_ddrt_write(val, addr)
#else
