...
/* ***** include chip,ddrc,phy,dmc define files ****************** */
#if defined(DDR_CHIP_SS626V100) || defined(CONFIG_SS626V100)
#include "hal/chip/ss626v100/ddrtrn_training_custom.h"
#else
#error Unknown Chip Type
#endif

#if defined(DDR_DDRC_V500_CONFIG)
#include "ddrtrn_ddrc_v500.h"
#elif defined(DDR_DDRC_V510_CONFIG)
#include "ddrtrn_ddrc_v510.h"
#elif defined(DDR_DDRC_V520_CONFIG)
#include "ddrtrn_ddrc_v520.h"
#elif defined(DDR_DDRC_S14_CONFIG)
#include "hal/ddrc/v0/ddrtrn_ddrc_s14.h"
#else
#error Unknown DDRC Type
#endif

#if defined(DDR_PHY_S40_CONFIG)
#include "ddrtrn_hal_phy_s40.h"
#elif defined(DDR_PHY_T28_CONFIG)
#include "ddrtrn_hal_phy_t28.h"
#elif defined(DDR_PHY_T16_CONFIG)
#include "ddrtrn_hal_phy_t16.h"
#elif defined(DDR_PHY_T12_V100_CONFIG)
#include "ddrtrn_hal_phy_t12_v100.h"
#elif defined(DDR_PHY_T12_V101_CONFIG)
#include "ddrtrn_hal_phy_t12_v101.h"
#elif defined(DDR_PHY_S14_CONFIG)
#include "hal/phy/v0/ddrtrn_hal_phy_s14.h"
#else
#error Unknown DDR PHY Type
#endif

#if defined(DDR_DDRT_S40_CONFIG)
#include "ddrtrn_ddrt_s40.h"
#elif defined(DDR_DDRT_T28_CONFIG)
#include "ddrtrn_ddrt_t28.h"
#elif defined(DDR_DDRT_T16_CONFIG)
#include "ddrtrn_ddrt_t16.h"
#elif defined(DDR_DDRT_T12_V100_CONFIG)
#include "ddrtrn_ddrt_t12_v100.h"
#elif defined(DDR_DDRT_V2_0_SHF0_CONFIG)
#include "hal/ddrt/v0/ddrtrn_ddrt_v2_0_shf0.h"
#elif defined(DDR_DDRT_V2_0_SHF1_CONFIG)
#include "hal/ddrt/v1/ddrtrn_ddrt_v2_0_shf1.h"
#elif defined(DDR_DDRT_V2_0_SHF2_CONFIG)
#include "hal/ddrt/v2/ddrtrn_ddrt_v2_0_shf2.h"
#else
#error Unknown DDR PHY Type
#endif
