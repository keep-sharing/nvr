...
static unsigned int ddrtrn_vref_get_win(struct ddrtrn_training_result_data *training, unsigned int vref)
{
...
static unsigned int ddrtrn_vref_find_best(struct ddrtrn_training_result_data *training, unsigned int vref, int step)
{
