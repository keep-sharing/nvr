...
typedef enum {
    ...
    HDMI_7680X4320P24_64_27 = 202,
    HDMI_7680X4320P25_64_27,
    HDMI_7680X4320P30_64_27,
    HDMI_4096X2160P100_256_135 = 218,
...
typedef enum {
    ...
    HDMI_VIDEO_TIMING_4096X2160P_48000,  /* 68 */
