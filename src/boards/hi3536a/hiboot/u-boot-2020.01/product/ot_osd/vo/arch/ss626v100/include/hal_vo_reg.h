...
typedef union {
    ...
    struct {
        ...
        unsigned int dac_reg_rev1 : 3;          /* [6..4]  */
        unsigned int dac_reg_dac0_cable_en : 1; /* [7]  */
        unsigned int dac_reg_dac1_cable_en : 1; /* [8]  */
        unsigned int dac_reg_dac2_cable_en : 1; /* [9]  */
...
/* define the union reg_hdmi1_csc_idc */
typedef union {
    /* define the struct bits */
    struct {
        unsigned int    cscidc0               : 11; /* [10..0]  */
...
/* define the union reg_hdmi1_csc_odc */
typedef union {
    /* define the struct bits */
    struct {
        unsigned int    cscodc0               : 11; /* [10..0]  */
...
/* define the union reg_hdmi1_csc_iodc */
typedef union {
    /* define the struct bits */
    struct {
        unsigned int    cscidc2               : 11; /* [10..0]  */
...
/* define the union reg_hdmi1_csc_p0 */
typedef union {
    /* define the struct bits */
    struct {
        unsigned int    cscp00                : 15; /* [14..0]  */
...
/* define the union reg_hdmi1_csc_p1 */
typedef union {
    /* define the struct bits */
    struct {
        unsigned int    cscp02                : 15; /* [14..0]  */
...
/* define the union reg_hdmi1_csc_p2 */
typedef union {
    /* define the struct bits */
    struct {
        unsigned int    cscp11                : 15; /* [14..0]  */
...
/* define the union reg_hdmi1_csc_p3 */
typedef union {
    /* define the struct bits */
    struct {
        unsigned int    cscp20                : 15; /* [14..0]  */
...
/* define the union reg_hdmi1_csc_p4 */
typedef union {
    /* define the struct bits */
    struct {
        unsigned int    cscp22                : 15; /* [14..0]  */
...
typedef union {
    ...
    struct {
        ...
        unsigned int    v1_prio               : 1; /* [2]  */
        unsigned int    v1h_prio              : 1; /* [3]  */
        unsigned int    v2_prio               : 1; /* [4]  */
        unsigned int    v2h_prio              : 1; /* [5]  */
        unsigned int    v3_prio               : 1; /* [6]  */
        unsigned int    v3h_prio              : 1; /* [7]  */
        unsigned int    g0_prio               : 1; /* [8]  */
        unsigned int    g1_prio               : 1; /* [9]  */
        unsigned int    g2_prio               : 1; /* [10]  */
        unsigned int    g3_prio               : 1; /* [11]  */
        unsigned int    g4_prio               : 1; /* [12]  */
        unsigned int    v0t_prio              : 1; /* [13]  */
        unsigned int    v1t_prio              : 1; /* [14]  */
        unsigned int    rchn31_prio           : 17; /* [31..15]  */
    } bits;
...
typedef union {
    ...
    struct {
        ...
        unsigned int    v0t_sel               : 2; /* [21..20]  */
        unsigned int    v1t_sel               : 2; /* [23..22]  */
...
typedef struct {
    ...
    volatile unsigned int           reserved_135[8]; /* 0xd1e0~0xd1fc 8 regs */
    ...
    volatile unsigned int           reserved_137[26]; /* 0xd218~0xd27c 26 regs */
    ...
    volatile unsigned int           reserved_138[10]; /* 0xd2c8~0xd2ec 10 regs */
    ...
    volatile unsigned int           reserved_140[5]; /* 0xd30c~0xd31c 5 regs */
    ...
    volatile unsigned int           reserved_141[16]; /* 0xd340~0xd37c 16 regs */
    ...
    volatile unsigned int           reserved_142[10]; /* 0xd3c8~0xd3ec 10 regs */
    ...
    volatile unsigned int           reserved_145[8]; /* 0xd430~0xd44c 8 regs */
    ...
    volatile reg_hdmi1_csc_idc        hdmi1_csc_idc; /* 0xd460 */
    volatile reg_hdmi1_csc_odc        hdmi1_csc_odc; /* 0xd464 */
    volatile reg_hdmi1_csc_iodc       hdmi1_csc_iodc; /* 0xd468 */
    volatile reg_hdmi1_csc_p0         hdmi1_csc_p0; /* 0xd46c */
    volatile reg_hdmi1_csc_p1         hdmi1_csc_p1; /* 0xd470 */
    volatile reg_hdmi1_csc_p2         hdmi1_csc_p2; /* 0xd474 */
    volatile reg_hdmi1_csc_p3         hdmi1_csc_p3; /* 0xd478 */
    volatile reg_hdmi1_csc_p4         hdmi1_csc_p4; /* 0xd47c */
    volatile unsigned int           reserved_146[32]; /* 0xd480~0xd4fc 32 regs */
    ...
    volatile unsigned int           reserved_147[5]; /* 0xd50c~0xd51c 5 regs */
    ...
    volatile unsigned int           reserved_148[3]; /* 0xd548~0xd550 3 regs */
    ...
    volatile unsigned int           reserved_149[3]; /* 0xd564~0xd56c 3 regs */
    ...
    volatile unsigned int           reserved_150[28]; /* 0xd580~0xd5ec 28 regs */
    ...
    volatile unsigned int           reserved_153[58]; /* 0xd618~0xd6fc 58 regs */
    ...
    volatile unsigned int           reserved_154[558]; /* 0xd748~0xdffc 558 regs */
    ...
    volatile unsigned int           reserved_155[3]; /* 0xe078~0xe080 3 regs */
    ...
    volatile unsigned int           reserved_158[558]; /* 0xe748~0xeffc 558 regs */
    ...
    volatile unsigned int           reserved_159[3]; /* 0xf078~0xf080 3 regs */
    ...
    volatile unsigned int           reserved_162[46]; /* 0xf748~0xf7fc 46 regs */
    ...
    volatile unsigned int           reserved_163; /* 0xf87c */
    ...
    volatile unsigned int           reserved_164; /* 0xf88c */
    ...
    volatile unsigned int           reserved_165[5]; /* 0xf8ac~0xf8bc 5 regs */
    ...
    volatile unsigned int             reserved_166_1; /* 0xf8e0 */
    ...
    volatile unsigned int           reserved_173[2]; /* 0x10068~0x1006c 2 regs */
    volatile reg_mac_debug_ctrl       mac_debug_ctrl; /* 0x10070 */
    volatile reg_mac_debug_clr        mac_debug_clr; /* 0x10074 */
    volatile unsigned int           reserved_174[2]; /* 0x10078~0x1007c 2 regs */
    volatile unsigned int           mac0_debug_info; /* 0x10080 */
    volatile unsigned int           reserved_175[3]; /* 0x10084~0x1008c 3 regs */
    ...
    volatile unsigned int           reserved_176[2]; /* 0x100a8~0x100ac 2 regs */
    ...
    volatile unsigned int           reserved_177[8]; /* 0x100e0~0x100fc 8 regs */
    ...
    volatile unsigned int           reserved_178[3]; /* 0x10114~0x1011c 3 regs */
    volatile reg_mac_axi_press0_ctrl5   mac_axi_press0_ctrl5; /* 0x10120 */
    volatile unsigned int           reserved_179[23]; /* 0x10124~0x1017c 23 regs */
    ...
    volatile unsigned int           reserved_185; /* 0x1027c */
    volatile reg_vid_smmu_bypass      vid_smmu_bypass; /* 0x10280 */
    volatile unsigned int           reserved_186[3]; /* 0x10284~0x1028c 3 regs */
    ...
    volatile unsigned int           reserved_191[2]; /* 0x10338~0x1033c 2 regs */
    volatile reg_vid_dcmp_ctrl        vid_dcmp_ctrl; /* 0x10340 */
    volatile unsigned int           vid_dcmp_l_fsize; /* 0x10344 */
    volatile unsigned int           reserved_192[14]; /* 0x10348~0x1037c 14 regs */
    ...
    volatile unsigned int           reserved_193[8]; /* 0x103a0~0x103bc 8 regs */
    ...
    volatile unsigned int           reserved_194[648]; /* 0x103e0~0x10dfc 648 regs */
    ...
    volatile unsigned int           reserved_195; /* 0x10e0c */
    volatile reg_gfx_mute_alpha       gfx_mute_alpha; /* 0x10e10 */
    volatile reg_gfx_mute_bk          gfx_mute_bk; /* 0x10e14 */
    volatile unsigned int           reserved_196[2]; /* 0x10e18~0x10e1c 2 regs */
    volatile reg_gfx_smmu_bypass      gfx_smmu_bypass; /* 0x10e20 */
    volatile unsigned int           reserved_197; /* 0x10e24 */
    volatile reg_gfx_1555_alpha       gfx_1555_alpha; /* 0x10e28 */
    volatile unsigned int           reserved_198[5]; /* 0x10e2c~0x10e3c 5 regs */
    ...
    volatile unsigned int           reserved_199[3]; /* 0x10e64~0x10e6c 3 regs */
    ...
    volatile unsigned int           reserved_200[28]; /* 0x10e80~0x10eec 28 regs */
    volatile unsigned int           gfx_work_addr; /* 0x10ef0 */
    volatile unsigned int           reserved_201[3]; /* 0x10ef4~0x10efc 3 regs */
    ...
    volatile unsigned int           reserved_205; /* 0x10f4c */
    ...
    volatile unsigned int           reserved_206[2]; /* 0x10f78~0x10f7c 2 regs */
    ...
    volatile unsigned int           reserved_207[541]; /* 0x10f8c~0x117fc 541 regs */
    volatile reg_wbc_ctrl             wbc_ctrl; /* 0x11800 */
    volatile reg_wbc_mac_ctrl         wbc_mac_ctrl; /* 0x11804 */
    volatile unsigned int           reserved_208[3]; /* 0x11808~0x11810 3 regs */
    volatile reg_wbc_smmu_bypass      wbc_smmu_bypass; /* 0x11814 */
    volatile unsigned int           reserved_209[2]; /* 0x11818~0x1181c 2 regs */
    ...
    volatile unsigned int           reserved_210[8]; /* 0x11830~0x1184c 8 regs */
    ...
    volatile unsigned int           reserved_211[2]; /* 0x11868~0x1186c 2 regs */
    ...
    volatile unsigned int           reserved_212[10]; /* 0x11888~0x118ac 10 regs */
    ...
    volatile unsigned int           reserved_213[16]; /* 0x118c0~0x118fc 16 regs */
    ...
    volatile unsigned int           reserved_214[8]; /* 0x11960~0x1197c 8 regs */
    ...
    volatile unsigned int           reserved_215[264]; /* 0x119e0~0x11dfc 264 regs */
    ...
    volatile unsigned int           reserved_216[43]; /* 0x11e54~0x11efc 43 regs */
    ...
    volatile unsigned int           reserved_217[2]; /* 0x11f58~0x11f5c 2 regs */
    volatile reg_od_pic_osd_stat_thr   od_pic_osd_stat_thr; /* 0x11f60 */
    volatile reg_od_pic_osd_pcmp      od_pic_osd_pcmp; /* 0x11f64 */
    volatile unsigned int           reserved_218[6]; /* 0x11f68~0x11f7c 6 regs */
    ...
    volatile unsigned int           reserved_219[26]; /* 0x11f98~0x11ffc 26 regs */
    ...
    volatile unsigned int           reserved_220[5]; /* 0x1202c~0x1203c 5 regs */
    volatile reg_v0_mrg_read_ctrl     v0_mrg_read_ctrl; /* 0x12040 */
    volatile reg_v0_mrg_read_en       v0_mrg_read_en; /* 0x12044 */
    volatile unsigned int           reserved_221[750]; /* 0x12048~0x12bfc 750 regs */
    ...
    volatile unsigned int           reserved_222[5]; /* 0x12c2c~0x12c3c 5 regs */
    volatile reg_v1_mrg_read_ctrl     v1_mrg_read_ctrl; /* 0x12c40 */
    volatile reg_v1_mrg_read_en       v1_mrg_read_en; /* 0x12c44 */
    volatile unsigned int           reserved_223[1262]; /* 0x12c48~0x13ffc 1262 regs */
    ...
    volatile unsigned int           reserved_224[509]; /* 0x1400c~0x147fc 509 regs */
    ...
    volatile unsigned int           reserved_225[509]; /* 0x1480c~0x14ffc 509 regs */
    ...
    volatile unsigned int           reserved_226[1021]; /* 0x1500c~0x15ffc 1021 regs */
    ...
    volatile unsigned int           reserved_227[48]; /* 0x16040~0x160fc 48 regs */
    ...
    volatile unsigned int           reserved_228[48]; /* 0x16140~0x161fc 48 regs */
    ...
    volatile unsigned int           reserved_229[48]; /* 0x16240~0x162fc 48 regs */
    ...
    volatile unsigned int           reserved_230[176]; /* 0x16340~0x165fc 176 regs */
    ...
    volatile unsigned int           reserved_231[53]; /* 0x1662c~0x166fc 53 regs */
    ...
    volatile unsigned int           reserved_232[3]; /* 0x16710~0x16718 3 regs */
    ...
    volatile unsigned int           reserved_233[533]; /* 0x1672c~0x16f7c 533 regs */
    volatile reg_gfx_osd_glb_info     gfx_osd_glb_info; /* 0x16f80 */
    volatile reg_gfx_osd_frame_size   gfx_osd_frame_size; /* 0x16f84 */
    volatile unsigned int           reserved_234[2]; /* 0x16f88~0x16f8c 2 regs */
