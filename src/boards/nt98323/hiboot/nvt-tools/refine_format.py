...
def main(argv):
    ...
    refine(sys.argv[1])
    #refine(r"z:\firmware\na51055_dual_sdk\na51055_linux_sdk\base\hdal\test_cases\hd_common_mem_alloc_test\hd_common_mem_alloc_test.c")
    #refine(r"z:\firmware\na51055_dual_sdk\na51055_linux_sdk\base\hdal\drivers\k_driver\source\comm\tse\tse.c")
    return 0
...
if __name__ == "__main__":
    def local_run():
        #sys.argv.append(r"D:\X2\tag10_56223_all\xxx.bin")
        #sys.argv.append(r"D:\X2\tag10_56223_all\mem_data.bin")
        #sys.argv.append(r"D:\X2\tag10_56223_all\HikKit_ldmap.txt")
        #sys.argv.append(r"0x08800000")
        if len (sys.argv) != 2:
