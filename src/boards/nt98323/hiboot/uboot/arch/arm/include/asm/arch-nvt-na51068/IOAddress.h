...
#define IOADDR_GPIO1_REG_BASE       (IOADDR_GLOBAL_BASE+0x0E420000)
#define IOADDR_GPIO2_REG_BASE       (IOADDR_GLOBAL_BASE+0x0E440000)
#define IOADDR_GPIO3_REG_BASE       (IOADDR_GLOBAL_BASE+0x0E640000)
...
// Ethernet
#define IOADDR_ETH_REG_BASE         (IOADDR_GLOBAL_BASE+0x0CC00000)
#define IOADDR_ETH1_REG_BASE        (IOADDR_GLOBAL_BASE+0x0CD00000)
...
// 32x only one SDIO
#define IOADDR_SDIO_REG_BASE        (IOADDR_GLOBAL_BASE+0x0A600000)


#define IOADDR_SDIO2_REG_BASE       (IOADDR_GLOBAL_BASE+0x0A600000)


#define IOADDR_SDIO3_REG_BASE       (IOADDR_GLOBAL_BASE+0x0A600000)
...
// USB
#define IOADDR_USB_REG_BASE         (IOADDR_GLOBAL_BASE+0x09100000)

// USB PHY
#define IOADDR_USBPHY_REG_BASE      (IOADDR_GLOBAL_BASE+0x0CF00000)

// USB port 2
#define IOADDR_USB2_REG_BASE        (IOADDR_GLOBAL_BASE+0x09200000)

// USB port 2 PHY
#define IOADDR_USB2PHY_REG_BASE     (IOADDR_GLOBAL_BASE+0x0D000000)

// USB3
#define IOADDR_USB3_REG_BASE        (IOADDR_GLOBAL_BASE+0x01700000)

// Crypto
#define IOADDR_CRYPTO_REG_BASE      (IOADDR_GLOBAL_BASE+0x0EC60000)
...
// eFUSE
#define IOADDR_EFUSE_REG_BASE       (IOADDR_GLOBAL_BASE+0x0ECE0000)
