...
typedef enum {
	...
	//< But QE (Quad Enable) bit is in Status Register[bit 9] (require SPI_FLASH_BUSWIDTH_QUAD_TYPE1_CMD31)
	...
	//< But QE CAN'T be modified by 0x31 command. Instead, QE is enabled by 0x01 command 2nd data byte
...
#define FLASH_CMD_RDSR3                  0x15            //FLASH CMD RDSR3
...
#define FLASH_CMD_DTR_FASTREAD           0x0D            //FLASH CMD DTR FAST READ
#define FLASH_CMD_DTR_DUAL_READ          0xBD            //FLASH CMD DTR DUAL READ
#define FLASH_CMD_DTR_QUAD_READ          0xED            //FLASH CMD DTR QUAD READ
#define FLASH_CMD_ENTER_4BYTE_ADDR       0xB7            //FLASH CMD Enter 4Byte address mode
#define FLASH_CMD_LEAVE_4BYTE_ADDR       0xE9            //FLASH CMD Leave 4Byte address mode
