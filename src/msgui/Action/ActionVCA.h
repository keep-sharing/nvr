...
class ActionSmartEvent : public ActionAbstract {
    Q_OBJECT
public:
    explicit ActionSmartEvent(QWidget *parent = nullptr);
    ~ActionSmartEvent() override;
...
private:
    smart_event *m_smartEvent = nullptr;
    SMART_EVENT_TYPE m_smartEventType = REGIONIN;
