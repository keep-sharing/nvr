#ifndef ACTIONAUDIOALARM_H
#define ACTIONAUDIOALARM_H

#include "ActionAbstract.h"

class ActionAudioAlarm : public ActionAbstract {
    Q_OBJECT
public:
    explicit ActionAudioAlarm(QWidget *parent = nullptr);
    ~ActionAudioAlarm() override;
    void readAction(int channel);
    void showAction(int channel);
    void saveAction(int channel, Uint64 chnMask);
