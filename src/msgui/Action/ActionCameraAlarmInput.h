#ifndef ACTIONCAMERAALARMINPUT_H
#define ACTIONCAMERAALARMINPUT_H

#include "ActionAbstract.h"

class ActionCameraAlarmInput : public ActionAbstract
{
    Q_OBJECT
...
public:
    explicit ActionCameraAlarmInput(QWidget *parent = nullptr);
    ~ActionCameraAlarmInput() override;

    void showAction(int channel, CAMERA_ALARMIN_IN_MODE alarmIndex);
    void saveAction();
...
private:
    CAMERA_ALARMIN_IN_MODE m_alarmIndex;
    QMap<int, Data> m_dataMap;

};

#endif // ACTIONCAMERAALARMINPUT_H
