#ifndef CAMERAEDITTABPARAMETERS_H
#define CAMERAEDITTABPARAMETERS_H
...
namespace Ui {
class CameraEditTabParameters;
}

class CameraEditTabParameters : public AbstractSettingTab
{
    Q_OBJECT

public:
    explicit CameraEditTabParameters(QWidget *parent = 0);
    ~CameraEditTabParameters();
...
private slots:
    ...
    void on_comboBox_codec_main_activated(int index);
...
private:
    ...
    //是否开启人脸隐私，开启后不允许修改码流codec和主码流分辨率
    bool m_isOpenFacePrivacy = false;
...
#endif // CAMERAEDITTABPARAMETERS_H
