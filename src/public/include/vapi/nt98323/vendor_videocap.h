...
********************************************************************/
#define VENDER_VIDEOCAP_VERSION		0x010001
...
typedef enum VENDOR_VIDEOCAP_PARAM_ID {
	...
	VENDOR_VIDEOCAP_PUSHPULL_RAWSIZE,	    ///<  support set, VENDOR_VIDEOCAP_PUSHPULL_INFO for changing
...
typedef struct _VENDOR_VIDEOCAP_PUSHPULL_INFO {
	HD_VIDEO_FRAME *pframe;
	unsigned int value;
} VENDOR_VIDEOCAP_PUSHPULL_INFO;
