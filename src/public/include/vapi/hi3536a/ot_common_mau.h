...
typedef enum {
    OT_SVP_MAU_TYPE_CONVERT_MODE_FP32_TO_FP16   = 0x0, /* fp32 to fp16 */
    OT_SVP_MAU_TYPE_CONVERT_MODE_FP16_TO_FP32  = 0x1, /* fp16 to fp16 */
...
typedef enum {
    OT_SVP_MAU_SORT_MODE_DESC  = 0x0, /* DESCENDING */
    OT_SVP_MAU_SORT_MODE_ASC   = 0x1, /* ASCENDING */
