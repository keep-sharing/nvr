 ...
 */
int
convert_record_to_array_ull(U_64 *array, int l_array, const char *record)
{
    int   i = 0;
    char *ptr;
    U_64  num;
 ...
 */
int
convert_record_to_array_double(double *array, int l_array, const char *record)
{
    int   i = 0;
    char *ptr;
    double  num;
...
merge_one_string(U_64 *array, int l_array, char *string, struct module *mod, int n_item)
{
    ...
    if ((len = convert_record_to_array_ull(array_2, l_array, string)) <= 0) {
        return 0;
    }
