...
#define RTP_PAYLOAD_FLAG_PACKET_IDR (1<<1)
#define RTP_PAYLOAD_FLAG_PACKET_MS_METADATA (1<<2)
#define RTP_PAYLOAD_MAX_LEN (3*1024*1024)
...
struct rtp_payload_t
{
	...
	void (*get_rtp_packet_ptr)(void* param,void **rtp_packet);
};
