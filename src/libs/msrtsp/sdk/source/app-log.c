...
static int app_log_time(char timestr[], unsigned int bytes)
{
	...
	return snprintf(timestr, bytes, "%4d-%02d-%02d %02d:%02d:%02d.%03d|", t.tm_year + 1900, t.tm_mon + 1, t.tm_mday, (int)t.tm_hour, (int)t.tm_min, (int)t.tm_sec, (int)(tv.tv_usec / 1000) % 1000);
#endif
