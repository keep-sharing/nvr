...
/// @defgroup xdstream 多媒体流传输库
/// @{
///

/// @defgroup xdstream-changes 变更日志
/// @{
///
/// @par 3.1.16 (2014/1/8)
///   - 增加 XD_StreamSetOutputFormat() 用于设置输出格式， 当前仅支持 AV_FOURCC_MP2P
///
/// @par 3.1.15 (2013/12/23)
///   - 限制数据帧最大值为 1024*1024 KB
///
/// @par 3.1.14 (2013/12/12)
///   - 增加 LIBXD_StreamEnableSourceEvent 配置项用于开启数据源事件通知， 这是为兼容以前旧版软件而设计， 默认此项功能是关闭的
///
/// @par 3.1.13 (2013/11/26)
///   - 更新接收内核到 2013.11.15
///
/// @par 3.1.12 (2013/10/31)
///   - 增加 XD_StreamSourceStarted 事件用来指示已经有数据到来
///
/// @par 3.1.11 (2013/7/20)
///   - 增加 URL 中包含认证信息的支持，格式如：rtsp://username:password@host:port/path
///
/// @par 3.1.10 (2013/7/17)
///   - 维护性更新
///
/// @par 3.1.9 (2013/7/9)
///   - 核心代码更新到 2013.07.03
///
/// @par 3.1.8 (2013/7/4)
///   - 修正在接入路数超过32路时容易发生崩溃的问题
///   - 修正定时器任务对象回收问题
///   - 修正数据包对象缓冲命中率低的问题
///
/// @par 3.1.7 (2013/6/25)
///   - 以 TCP 方式连接存在问题，暂时恢复 RTCP 相关代码
///
/// @par 3.1.6 (2013/2/27)
///   - 增加 XD_StreamSetAuth()
///   - 增加 GET_PARAMETER 保活机制
///   - 移除 RTCP 相关功能
///
/// @par 3.1.5 (2013/2/2)
///   - 修改默认超时值为 10000 以适应更多响应速度快慢不一的设备
///
/// @par 3.1.4 (2013/1/30)
///   - 修正数据接收超时事件响应不正确的问题
///   - 修正频繁打开关闭实例时资源泄漏问题
...
///
/// @par 3.1.2 (2013/1/16)
///   - 修正触发器回调可能被覆盖导致线程无法被唤醒的问题
///
/// @par 3.1.1 (2013/1/15)
///   - 增日调式日志信息
///
/// @par 3.1.0 (2013/1/6)
///   - 变更 libXD_StreamInit() 为 libXD_Stream_Init()
///   - 变更 libXD_StreamFini() 为 libXD_Stream_Fini()
///   - 增加 #LIBXD_STREAM_VERSION
///   - 增加 libXD_Stream_Version()
///   - 增加 libXD_Stream_VersionNumber()
///
/// @par 3.0 (2012/12/20)
///   - 初始版本建立
///
