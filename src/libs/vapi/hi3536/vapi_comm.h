...
#define VAPIERR(format, ...)                                                                                                                                                       \
    do {                                                                                                                                                                           \
        VAPILOG(format, ##__VA_ARGS__);                                                                                                                                            \
        char  stime[32] = {0};                                                                                                                                                     \
        char  log[1024] = {0};                                                                                                                                                     \
        char  cmd[128]  = {0};                                                                                                                                                     \
        int   filesize  = -1;                                                                                                                                                      \
...
#define VAPI_VDEC_MAX_WIDTH_265     (4000)
#define VAPI_VDEC_MAX_HEIGTH_265    (4000)
