                            ...
                            HI_U32 u32Width, HI_U32 u32Height)
{
    ...
    if (PT_H265 == enPT) {
        if (u32Width > VAPI_VDEC_MAX_WIDTH_265 || u32Height > VAPI_VDEC_MAX_HEIGTH_265) {
            VAPILOG("resolution must be <= %dX%d", VAPI_VDEC_MAX_WIDTH_265, VAPI_VDEC_MAX_HEIGTH_265);
            return HI_FAILURE;
        }
    } else {
