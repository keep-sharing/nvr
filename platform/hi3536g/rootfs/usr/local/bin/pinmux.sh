...
if [ "$1" = "aic31" ]; then
    ...
    #uart 
		himm 0x120F0138 0x1;    # uart1_rtsn
    himm 0x120F0130 0x1;    # uart1_rxd
    himm 0x120F013C 0x1;    # uart1_ctsn
    himm 0x120F0134 0x1;    # uart1_txd

    himm 0x120F0164 0x1;    # uart3_rxd
    himm 0x120F0168 0x1;    # uart3_txd
