...
public:
    ...
    void setWaitForVSyncCallback(std::function<void(int)> func) override;
    void setFbVisible(bool) override;
    void setFbVisibleCallback(std::function<void(int, bool)> func) override;

    QLinuxFb_Shared * shared = nullptr;
