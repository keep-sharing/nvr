...
//usage:     "\n	-a		Auto login as root"
//usage:     "\n"
//usage:     "\nBAUD_RATE of 0 leaves it unchanged"

#define OPT_STR "I:LH:f:hil:mt:+wna"
...
int getty_main(int argc UNUSED_PARAM, char **argv)
{
	...
	option_mask32 |= F_AUTOLOGIN;

	if (option_mask32 & F_AUTOLOGIN) {
		logname = "root";
		param = "-f";
	} else
		param = "--";
	...
	BB_EXECLP(G.login, G.login, param, logname, (char *)0);
