...
#ifdef __linux__
//config: config FEATURE_RTOS_VLOCK_CLEAN_SCREEN
//config: bool "clean the screen when locks"
//config: default n
//config: depends on VLOCK
//config: help
//config: With this option busybox support clean the screen
//config: when vlock is enabled.
#if ENABLE_FEATURE_RTOS_VLOCK_CLEAN_SCREEN
