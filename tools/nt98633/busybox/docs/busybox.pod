...
Currently available applets include:
	...
	[, [[, acpid, add-shell, addgroup, adduser, ar, arch, arp, arping,
	ash, awk, basename, bc, beep, blkdiscard, blkid, blockdev,
	bootchartd, brctl, bunzip2, bzcat, bzip2, cal, cat, chat, chattr,
	chgrp, chmod, chown, chpasswd, chpst, chroot, chrt, chvt, cksum,
	clear, cmp, conspy, cp, cpio, crond, crontab, cryptpw, cttyhack,
	...
	envuidgid, expand, expr, factor, fakeidentd, fallocate, false,
	...
	gunzip, gzip, halt, hd, head, hexdump, hexedit, hostid, hostname,
	httpd, hush, hwclock, i2cdetect, i2cdump, i2cget, i2cset,
	i2ctransfer, id, ifconfig, ifdown, ifup, inetd, init, insmod,
	install, iostat, ip, ipaddr, ipcalc, ipcrm, ipcs, iplink, ipneigh,
	iproute, iprule, iptunnel, kill, killall, killall5, klogd, last,
	less, link, linux32, linux64, linuxrc, ln, loadfont, loadkmap,
	logger, login, logname, logread, losetup, ls, lsattr, lsmod, lsof,
	lsscsi, lsusb, lzcat, lzop, md5sum, mdev, mesg, microcom, mkdir,
	mkdosfs, mke2fs, mkfifo, mkfs.ext2, mkfs.minix, mkfs.vfat, mknod,
	mkpasswd, mkswap, modinfo, modprobe, more, mount, mpstat, mv,
	nanddump, nandwrite, netstat, nice, nl, nmeter, nohup, nologin,
	nproc, nsenter, nslookup, ntpd, nuke, od, partprobe, passwd, paste,
	patch, pgrep, pidof, ping, ping6, pivot_root, pkill, pmap, poweroff,
	powertop, printenv, printf, ps, pstree, pwd, pwdx, rdate, rdev,
	readahead, readlink, readprofile, realpath, reboot, remove-shell,
	renice, reset, resume, rev, rm, rmdir, rmmod, route, rtcwake,
	run-init, runsv, runsvdir, script, scriptreplay, sed, seq, setarch,
	setconsole, setfattr, setpriv, setserial, setuidgid, sh, showkey,
	shred, slattach, sleep, smemcap, softlimit, sort, ssl_client, stat,
	stty, su, sulogin, sv, svc, svlogd, svok, swapoff, swapon,
	switch_root, sync, sysctl, syslogd, tail, tar, taskset, tc, tcpsvd,
	tee, telnet, telnetd, test, tftp, tftpd, time, top, touch, tr,
	traceroute, traceroute6, true, truncate, ts, tty, tune2fs,
	ubiattach, ubidetach, ubimkvol, ubirename, ubirmvol, ubirsvol,
	ubiupdatevol, udhcpc, udhcpd, udpsvd, uevent, umount, uname,
	uncompress, unexpand, uniq, unix2dos, unshare, unzip, uptime, users,
	usleep, uudecode, uuencode, vconfig, vi, vlock, w, wall, watch,
	watchdog, wc, wget, who, whoami, whois, xargs, xxd, xzcat, zcat,
	zcip
